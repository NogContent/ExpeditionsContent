...
using System.IO;
using ExpeditionsContent144.NPCs;
...
{
	public class ExpeditionC144 : Mod
	{
		public ExpeditionC144()
		{
		...
		public static Asset<Texture2D> CameraFrameTexture;

		public override void Load()
		{
			npcidclerk = ModContent.NPCType<Clerk>();
			itemidphoto = ModContent.ItemType<Items.QuestItems.Photo>();

			if (Main.netMode != 2)
			{
				CameraFrameTexture = this.Assets.Request<Texture2D>("Gores/CameraFrame");
			}
	...
	public class ExpeditionsC144System : ModSystem
	{
		public override void PostDrawInterface(SpriteBatch spriteBatch)
		{
			...
			spriteBatch.Draw(TextureAssets.MagicPixel.Value, new Rectangle(0, 0, 300, 200), Color.Red);
			spriteBatch.DrawString(font, "Expeditions", new Vector2(30-p, 20), Color.Black, 0, Vector2.Zero, scale, SpriteEffects.None, 0);
			spriteBatch.DrawString(font, "Expeditions", new Vector2(30, 20-p), Color.Black, 0, Vector2.Zero, scale, SpriteEffects.None, 0);
			spriteBatch.DrawString(font, "Expeditions", new Vector2(30+p, 20), Color.Black, 0, Vector2.Zero, scale, SpriteEffects.None, 0);
			spriteBatch.DrawString(font, "Expeditions", new Vector2(30, 20+p), Color.Black, 0, Vector2.Zero, scale, SpriteEffects.None, 0);
			spriteBatch.DrawString(font, "Expeditions", new Vector2(30, 20), Color.White, 0, Vector2.Zero, scale, SpriteEffects.None, 0);*/
		}

		public override void PostDrawFullscreenMap(ref string mouseText)
		{
			ModMapController.DrawFullscreenMap(Mod, ref mouseText);
		}
	}

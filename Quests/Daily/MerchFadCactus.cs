...
{
	class MerchFadCactus : ModExpedition
	{
		public override void SetDefaults()
		{
			expedition.name = "Cactus Craze";
		...
		{
			AddDeliverable(ItemID.CactusChair, 1);
			AddDeliverable(ItemID.CactusTable, 1);
			AddDeliverableAnyOf(new int[] {
				ItemID.CactusSofa,
				ItemID.CactusSink,
				ItemID.CactusChandelier}, 1);
		...
		public override string Description(bool complete)
		{
			...
			return "There's a fad going on for cacti! If you can aquire a selection of furniture for me, I could make a big profit! Oh, and " + clerk + " will give you something for your troubles, I'm sure. ";
		}

...
{
	class SnapHardCorruptSlime : ModExpedition
	{
		public override void SetDefaults()
		{
			expedition.name = "Super Snap! Corrupt Slime";
		...
		{
			return "There's a mail-in photo challenge happening on right now! Want to enter? Today's target is a Corrupt Slime which can be found in the corruption, and you have until tomorrow to submit. Good luck!";
		}
		...
		{
			cond1 = PhotoManager.PhotoOfNPC[NPCID.CorruptSlime];
			return cond1;
		}

		public override void PreCompleteExpedition(List<Item> rewards, List<Item> deliveredItems)
		{
			PhotoManager.ConsumePhoto(NPCID.CorruptSlime);
		}
	}
}

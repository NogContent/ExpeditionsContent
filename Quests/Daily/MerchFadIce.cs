...
{
	class MerchFadFrozen : ModExpedition
	{
		public override void SetDefaults()
		{
			expedition.name = "Frozen Assets";
		...
		{
			AddDeliverable(ItemID.FrozenChair, 1);
			AddDeliverable(ItemID.FrozenTable, 1);
			AddDeliverableAnyOf(new int[] {
				ItemID.FrozenSofa,
				ItemID.FrozenSink,
				ItemID.FrozenChandelier}, 1);
		...
		public override string Description(bool complete)
		{
			...
			return "There's an fad going on for ice! If you can aquire a selection of furniture for me, I could make a big profit! Oh, and " + clerk + " will give you something for your troubles, I'm sure. ";
		}

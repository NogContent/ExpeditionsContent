...
{
	class SnapHardBloodJelly : ModExpedition
	{
		public override void SetDefaults()
		{
			expedition.name = "Super Snap! Blood Jelly";
		...
		{
			return "There's a mail-in photo challenge happening on right now! Want to enter? Today's target is a Blood Jelly which can be found in the crimson, and you have until tomorrow to submit. Good luck!";
		}
		...
		{
			cond1 = PhotoManager.PhotoOfNPC[NPCID.BloodJelly];
			return cond1;
		}

		public override void PreCompleteExpedition(List<Item> rewards, List<Item> deliveredItems)
		{
			PhotoManager.ConsumePhoto(NPCID.BloodJelly);
		}
	}
}

...
{
	class MerchGel : ModExpedition
	{
		public override void SetDefaults()
		{
			expedition.name = "Gel-Economy";
		...
		public override string Description(bool complete)
		{
			...
			return "Hey, you know what sells really well right now? Gel. Overseas that is, I'm not paying you any extra to get it for me. But I'll put in a word with " + clerk + ", how's that? Now get me 50.";
		}

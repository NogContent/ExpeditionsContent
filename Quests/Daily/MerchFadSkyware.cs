...
{
	class MerchFadSkyware : ModExpedition
	{
		public override void SetDefaults()
		{
			expedition.name = "Skyward Prices";
		...
		{
			AddDeliverable(ItemID.SkywareChair, 1);
			AddDeliverable(ItemID.SkywareTable, 1);
			AddDeliverableAnyOf(new int[] {
				ItemID.SkywareSofa,
				ItemID.SkywareSink,
				ItemID.SkywareChandelier}, 1);
		...
		public override string Description(bool complete)
		{
			...
			return "There's an fad going on for skyware! If you can aquire a selection of furniture for me, I could make a big profit! Oh, and " + clerk + " will give you something for your troubles, I'm sure. ";
		}

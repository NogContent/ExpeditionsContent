...
{
	class DyeForBlue : ModExpedition
	{
		...
		{
			AddDeliverable(ItemID.BlueFlameDye, 1);
			AddRewardItem(API.ItemIDExpeditionCoupon, 1);
		}
		public override string Description(bool complete)
		{
			return "I only sell high quality dyes, but I do love seeing the variety of wonderful colours this place has to offer once in a while! Show off your mixing skills, and present me a beautiful hue of deep blues! ";
		}
